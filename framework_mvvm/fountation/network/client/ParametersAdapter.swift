...
struct URLQueryEncoder: RequestAdapter {
    ...
    func adapted(_ request: URLRequest) throws -> URLRequest {
        ...
        guard let url = request.url else {
            throw DXError.missingURL // LineSDKError.requestFailed(reason: .missingURL)
        }
...
struct JSONParameterEncoder: RequestAdapter {
    ...
    func adapted(_ request: URLRequest) throws -> URLRequest {
        ...
        do {
            ...
            throw DXError.jsonEncodingFailed // LineSDKError.requestFailed(reason: .jsonEncodingFailed(error))
        }
